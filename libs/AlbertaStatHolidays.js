...
var AlbertaStatHolidays = {
    ...
    getStatHolidays: function (year, province = "Alberta") {
        ...
        this.statHolidays.push(this.getHeritageDay(year));
    ...
    getHeritageDay: function (year, province = "Alberta") {
    ...
    getRemembranceDay: function (year, province = "Alberta") {
        ...
        // Saturday
        if (weekday === 6) {
            return { id: year + "11" + today, name: "Remembrance Day", reserved: true, reservedDate: year + "1110" };
        }
        // Sunday
        else if (weekday === 0) {
            return { id: year + "11" + today, name: "Remembrance Day", reserved: true, reservedDate: year + "1112" };
        }
        else {
            return { id: year + "11" + today, name: "Remembrance Day", reserved: false };
        }
    },
    ...
    getChrismasDay: function (year, province = "Alberta") {
        ...
        // Saturday
        if (weekday === 6) {
            return { id: year + "12" + today, name: "Chrismas", reserved: true, reservedDate: year + "1227" };
        }
        // Sunday
        else if (weekday === 0) {
    ...
    getBoxingDay: function (year, province = "Alberta") {
    ...
    getEasterSunday: function (year, province = "Alberta") {
        var f = Math.floor,
            // Golden Number - 1
            G = year % 19,
            C = f(year / 100),
...
export default AlbertaStatHolidays;